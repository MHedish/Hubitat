...
[![Version](https://img.shields.io/badge/version-1.0.2.0-blue.svg)](./CHANGELOG.md)
...
- Improved irrigation reliability by prioritizing zone control commands over background telemetry, reducing transport contention during active watering; gated maintenance polling to idle controller state.
