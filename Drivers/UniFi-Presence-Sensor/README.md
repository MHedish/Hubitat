...
![version](https://img.shields.io/badge/version-v1.8.5.0-blue)
...
> **Note:** This is the current **stable release** (`v1.8.5.0`, 2026-02-15).  
...
Latest release: **v1.8.5.0 (2026-02-15)** – stable release.  
