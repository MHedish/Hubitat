...
![version](https://img.shields.io/badge/version-v1.8.6.7-blue)
...
> **Note:** This is the current **stable release** (`v1.8.6.7`, 2026-03-16).  
...
Latest release: **v1.8.6.6 (2026-03-07)** – stable release.  
