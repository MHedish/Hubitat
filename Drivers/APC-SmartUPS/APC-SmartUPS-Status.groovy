...
private def getTransient(String key) {return transientContext[key]}
private void clearTransient(String key = null) {if (key) transientContext.remove(key)else transientContext.clear()}
