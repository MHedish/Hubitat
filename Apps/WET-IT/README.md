...
- Updated child version detection in verifySystem().  The previous verions only looked for the presence of the child device, not i
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzI1NTg4NDY5LDk1NDYwMzU3NywtNzQzMj
