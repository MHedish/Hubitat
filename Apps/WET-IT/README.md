...
- Updated irrigationTick() to use solar cache as authoritative (increases *resolution*) with hub fallback.  The WET-IT solar cache provides all six solar events with 
- Added notifications when operating in degraded mode.
- Application UI cleanup 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTYzNjI4NDAzMiw5NTQ2MDM1NzcsLTc0Mz
