...
*
*  Child driver for WET-IT app. Exposes program control to Alexa devices.
*
*  Changelog:
...
@Field static final String DRIVER_VERSION  = "0.0.1.1"
...
metadata {
    definition(
        ...
        namespace: "MHedish",
        author: "Marc Hedish",
        description: "Alexa child device for WET-IT program control.",
